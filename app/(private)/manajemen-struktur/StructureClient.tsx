      ...
      if (activeTab === "periods") {
        ...
        const payload = {
          ...
          sort_order: formData.sort_order
            ? parseInt(formData.sort_order as string)
            : null,
        };
        if (dialogType === "update" && !activeItem?.id) return;
        result =
                ...
                <tbody className="text-xs">
                    ...
                    .map((item) => (
                      ...
                      >
                        ...
                        <td className="p-4">
                          <Badge
                            variant="outline"
                            className="rounded-sm bg-zinc-100 dark:bg-zinc-800 border-zinc-200 dark:border-zinc-700"
                          >
                            {item.role_name}
                          </Badge>
                        </td>
                  ...
                  {initialOrgHistories.length === 0 && (
                    <tr>
                      <td
                        colSpan={5}
                        className="p-8 text-center text-zinc-500 font-mono text-xs uppercase"
                      >
                    ...
                    >
                      ...
                      <td className="p-4">
                        {item.is_active ? (
                          ...
                          <Badge
                            variant="outline"
                            className="rounded-sm font-mono uppercase text-[9px]"
                          >
                            Tidak Aktif
                          </Badge>
                        )}
