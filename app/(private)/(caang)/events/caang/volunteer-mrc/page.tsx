...
import VolunteerRegistrationForm from "@/app/(private)/(caang)/events/caang/volunteer-mrc/VolunteerRegistration";
import RegistrationStatus from "@/app/(private)/(caang)/events/caang/volunteer-mrc/RegistrationStatus";
import AlreadyRegistered from "@/app/(private)/(caang)/events/caang/volunteer-mrc/AlreadyRegistered";
...
const REGISTRATION_END = new Date("2025-10-14T12:00:00+07:00");
