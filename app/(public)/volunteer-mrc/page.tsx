...
import VolunteerRegistrationForm from "@/app/(public)/volunteer-mrc/VolunteerRegistration";
import RegistrationStatus from "@/app/(public)/volunteer-mrc/RegistrationStatus";
...
export default function VolunteerPage() {
  ...
  const REGISTRATION_START = useMemo(
    () => new Date("2025-10-06T00:00:00+07:00"),
    []
  ); // 6 Oktober 2025 pukul 00:00 WIB
  const REGISTRATION_END = useMemo(
    () => new Date("2025-10-11T23:59:59+07:00"),
    []
