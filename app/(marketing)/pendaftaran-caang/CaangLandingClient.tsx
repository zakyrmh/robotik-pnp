...
export function CaangLandingClient({ settings }: CaangLandingClientProps) {
  ...
  const defaultTimeline: TimelineEvent[] = [
    {
      ...
      description:
        "Pengisian form pendaftaran & pengunggahan berkas administrasi via web resmi.",
    },
    {
      ...
      end_date: "2026-09-25",
      description:
        "Verifikasi kelengkapan dokumen calon anggota oleh tim panitia pendaftaran.",
    },
    {
      ...
      end_date: "2026-10-02",
      description:
        "Sesi interview motivasi, minat divisi (Mekanik/Elektronika/Programming), serta tes dasar.",
    },
    {
      ...
      end_date: "2026-11-15",
      description:
        "Pengenalan riset robot, workshop teknis divisi, piket laboratorium, dan pembuatan miniproject.",
    },
    {
      ...
      end_date: "2026-11-20",
      description:
        "Pengumuman kelulusan akhir dan penyerahan SK Pelantikan Anggota Muda UKM Robotik PNP.",
    },
  ];
  ...
  const faqs = [
    {
      question:
        "Siapa saja yang boleh mendaftar calon anggota UKM Robotik PNP?",
      answer:
        "Seluruh mahasiswa aktif Politeknik Negeri Padang (PNP) untuk tingkat D3 maksimal semester 1 dan untuk tingkat D4 maksimal semester 3 dari seluruh jurusan.",
    },
    {
      question: "Apakah harus sudah punya keahlian robotika/koding sebelumnya?",
      answer:
        "Tidak wajib! Yang paling penting adalah rasa ingin tahu yang tinggi, komitmen, dan semangat belajar. Kamu akan dibimbing dari dasar saat masa magang dan training.",
    },
    {
      question: "Apa saja divisi yang bisa saya pilih di UKM Robotik?",
      answer:
        "Terdapat divisi Kontes Robot Indonesia (KRI) seperti KRAI (Robot Beroda), KRSBI-H (Robot Sepakbola Humanoid), KRSBI-B (Robot Sepakbola Beroda), KRSTI (Robot Seni Tari), KRSRI (Robot SAR).",
    },
    {
      question: "Bagaimana alur pendaftarannya?",
      answer:
        "Buat akun pendaftaran di web ini, isi biodata diri & data akademik, serta unggah dokumen pendukung seperti KTM & pasfoto.",
    },
    {
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl space-y-16">
        ...
        <div className="text-center space-y-4 max-w-3xl mx-auto pt-4">
          ...
          <p className="text-muted-foreground text-sm sm:text-base leading-relaxed">
            Wadah resmi mahasiswa Politeknik Negeri Padang untuk mengembangkan
            potensi rekayasa robotika, sistem cerdas, mekatronika, dan
            ...
            <div className="w-full md:w-auto flex flex-col items-center min-w-[260px] sm:min-w-[320px] bg-surface border border-border/80 rounded-xl p-6">
              ...
              {(state === "opening_soon" || state === "open") && (
                <div className="grid grid-cols-3 gap-3 w-full">
                  ...
                  <div className="flex flex-col items-center bg-card border border-border p-3 rounded-lg">
                    <span className="text-2xl font-bold font-mono text-primary animate-pulse">
        ...
        <div id="syarat" className="space-y-8 scroll-mt-24">
          <div className="text-center space-y-2">
            <h2 className="text-2xl sm:text-3xl font-bold font-display">
              Syarat & Kriteria Pendaftaran
            </h2>
            <p className="text-muted-foreground text-sm">
              Persyaratan utama calon anggota baru UKM Robotik PNP
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-card border border-border rounded-xl p-6 space-y-3">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Tercatat sebagai mahasiswa aktif Politeknik Negeri Padang
                (Tingkat D3 maksimal semester 1 dan Tingkat D4 maksimal semester
                3 seluruh jurusan).
              </p>
            </div>
            ...
            <div className="bg-card border border-border rounded-xl p-6 space-y-3">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Memiliki ketertarikan tinggi terhadap ilmu mekanik, elektronika,
                embedded system, atau pemograman robot.
              </p>
            </div>
            ...
            <div className="bg-card border border-border rounded-xl p-6 space-y-3">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Siap mengikuti pelatihan, alur magang, pembekalan workshop, mini
                project, dan memiliki disiplin organisasi.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-8">
          <div className="text-center space-y-2">
            <h2 className="text-2xl sm:text-3xl font-bold font-display">
              Alur & Timeline Pendaftaran
            </h2>
            <p className="text-muted-foreground text-sm">
              Tahapan kegiatan dari pendaftaran hingga pengangkatan anggota
            </p>
          </div>
        ...
        <div id="faq" className="space-y-8 scroll-mt-24">
          <div className="text-center space-y-2">
            ...
            <p className="text-muted-foreground text-sm">
              Temukan jawaban atas pertanyaan seputar pendaftaran
            </p>
          </div>
        ...
        <div className="bg-gradient-to-r from-primary/10 via-surface to-accent/10 border border-border rounded-2xl p-8 sm:p-12 text-center space-y-6">
          ...
          <p className="text-muted-foreground text-sm sm:text-base max-w-xl mx-auto">
            Jangan lewatkan kesempatan menjadi inovator muda teknologi
            Politeknik Negeri Padang. Daftarkan dirimu sebelum batas waktu
            habis!
          </p>
