...
export const metadata: Metadata = {
  ...
  description: "Dapur Inovasi & Pusat Riset Teknologi Robotika Politeknik Negeri Padang. Wadah bagi mahasiswa kreatif, solutif, dan inovatif di bidang robotika.",
  openGraph: {
    title: "Profil | UKM Robotika PNP",
    description: "Kenali lebih dekat identitas, arah gerak, sejarah, dan ekosistem riset Unit Kegiatan Mahasiswa Robotika Politeknik Negeri Padang.",
    type: "website",
  },
};
