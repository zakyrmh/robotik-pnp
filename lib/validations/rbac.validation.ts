...
import { z } from "zod";
const DIVISION_ROLE = ["mekanik", "elektrikal", "programmer"];
...
export type RolePermissionInsertInput = z.infer<
  typeof rolePermissionInsertSchema
>;
...
export const userRoleInsertSchema = z.object({
  ...
  assigned_by: z
    .string()
    .uuid("Assigned by ID tidak valid")
    .nullable()
    .optional(),
});
...
export type UserDepartmentInsertInput = z.infer<
  typeof userDepartmentInsertSchema
>;
export type UserDepartmentUpdateInput = z.infer<
  typeof userDepartmentUpdateSchema
>;
