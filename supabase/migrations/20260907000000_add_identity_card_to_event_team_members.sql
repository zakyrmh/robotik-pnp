-- Migration: Add identity_card_url to event_team_members table
-- Field for uploading student ID card or family card (Kartu Pelajar / Kartu Keluarga)

-- 1. Add column to event_team_members
ALTER TABLE public.event_team_members
    ADD COLUMN IF NOT EXISTS identity_card_url TEXT;

-- 2. Update register_team RPC function to accept and store identity_card_url
