...
interface AbsensiHistoryClientProps {
  profileName: string;
  nim: string;
  role: string;
...
export function AbsensiHistoryClient({
  profileName,
  nim,
  role,
  initialHistory,
}: AbsensiHistoryClientProps) {
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="text-xs font-mono uppercase tracking-wider text-slate-500 dark:text-slate-400 mt-1">
              Catatan Lengkap Kehadiran &amp; Dispensasi Kegiatan UKM Robotik
              PNP
            </p>
          </div>
