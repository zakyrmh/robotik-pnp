...
export function PageLoader({ message = "Memuat data..." }: PageLoaderProps) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-linear-to-br from-slate-50 via-slate-100 to-slate-200">
      {/* Background Pattern */}
      ...
      >
        ...
        >
          ...
          <div className="relative w-20 h-20 rounded-2xl bg-white shadow-xl p-4 ring-1 ring-slate-200">
            <Image
              src="/images/logo.png"
              alt="Robotik PNP"
              fill
