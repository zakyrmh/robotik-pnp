...
import { auth } from "@/lib/firebaseConfig"; // Sesuaikan path dengan konfigurasi Firebase Anda
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex space-x-6 items-center">
            ...
            {loading ? (
              <div className="w-20 h-9 bg-slate-200 dark:bg-slate-700 animate-pulse rounded-md"></div>
            ) : user ? (
              <DropdownMenu>
        ...
        <div className="md:hidden bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-700">
          <div className="space-y-2 px-4 py-3">
            ...
            <div className="pt-2 border-t border-slate-200 dark:border-slate-700">
              {loading ? (
                <div className="w-full h-9 bg-slate-200 dark:bg-slate-700 animate-pulse rounded-md"></div>
              ) : user ? (
                <>
                  <button
                    onClick={() => {
